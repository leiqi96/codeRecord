package com.wuanquan.db;

import java.lang.reflect.Field;
import java.util.Arrays;

import com.wuanquan.annotation.Column;
import com.wuanquan.annotation.Id;
...
public class SimpleDbPipe<E> {
    ...
    private String getInsertSql(String tableName, int length) {
        ...
        sql.append("insert into ").append(tableName).append(SPACE).append("values(");
